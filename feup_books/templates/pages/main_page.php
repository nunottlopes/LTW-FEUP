<div class="main_page">
    ...
    <div class="main_page_aside">
        <div class="aside_create_post">
            <p>Create Post</p>
            <a href="#"><button class="create_post_button" type="button">CREATE POST</button></a>
        </div>

        <div class="aside_favorite_post">
